...
- 幽灵互动系统：幽灵会接受贡品、与其他幽灵对话，特殊条件下生成特殊幽灵并解锁“死者图鉴”。  
...
- 特殊事件：实现幽灵交互对话、接受贡品、特殊幽灵生成与“死者图鉴”解锁功能。  
...
- GhostController.cs：幽灵 AI 状态机（Idle、Wander、ReceiveOffering、TalkWithGhost、Vanish）；可接受贡品、发起幽灵对话、解锁特殊幽灵与“死者图鉴”。  
...
- Ghost Interaction System: Ghosts can receive offerings, talk to other ghosts, and trigger special ghosts that unlock entries in the Ghost Codex.  
...
- Special Events: Ghost dialogues, offering acceptance, special ghost spawning, and Ghost Codex unlocking.  
...
- GhostController.cs: Ghost AI state machine (Idle, Wander, ReceiveOffering, TalkWithGhost, Vanish); accepts offerings, triggers dialogues, and unlocks special ghosts for the Codex.  
